    ...
    if( opened ){
        ...
        <View style={{'position':'absolute', 'top': topMargin,'left':leftMargin}}>
          <TouchableWithoutFeedback onPress={this._onToggle} >
            <View style={{justifyContent: 'center', alignSelf: 'center' }}>
              <SvgIcon name="chevron-up" height={height/2} width={height/2} stroke={iconColor} svgs={svgs} strokeWidth={height/10} fill={"transparent"}/>
            </View>
          </TouchableWithoutFeedback>
        </View>
      )
      ...
      return (
        <View style={{'position':'absolute', 'top': topMargin,'left':leftMargin}}>
          <TouchableWithoutFeedback onPress={this._onToggle} >
            <View style={{justifyContent: 'center', alignSelf: 'center' }}>
              <SvgIcon name="chevron-down" height={height/2} width={height/2} stroke={iconColor} svgs={svgs} strokeWidth={height/10} fill={"transparent"}/>
            </View>
          </TouchableWithoutFeedback>
        </View>
      )        
