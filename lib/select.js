...
class Select extends Component {
  ...
  render() {
    const { width, height, children, defaultValue, style, checkboxStyles, optionStyles, overlayStyles, styleText, checkable } = this.props;
    ...
    if( checkable ) {
      return (
        <View>
          <OptionList ref="OPTIONLIST" checkable={checkable} overlayStyles={mergeStyle}/>
        </View>
      );
    } else {
      return (
