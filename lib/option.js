    ...
    if( checkable ){
      return (
        <View style={[ styles.container, style, {'flexDirection':'row'}, {height:height}]}>
          <Checkbox style={{backgroundColor: 'white', color:'black', borderRadius: 5}} checkboxStyles={checkboxStyles} checked={checked} name={this.props.children} onChange={onChange}/>
