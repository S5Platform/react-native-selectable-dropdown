...
class Checkbox extends Component {
    ...
    return (
      <TouchableHighlight underlayColor='transparent'
        ...
        <View style={{flex: 1, alignItems: 'center'}}>
          { this.state.checked &&
          <SvgIcon name="checkbox-checked" height={SIZE - 5} width={SIZE - 5} stroke={COLOR} svgs={svgs} strokeWidth={SIZE/5} fill={"transparent"}/>
          }
        </View>
      </TouchableHighlight>
    );
  ...
  _toggleCheck() {
    ...
    this.props.onChange && this.props.onChange(this.props.name, this.props.value, checked);
  }
}
